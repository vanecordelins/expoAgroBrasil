...
public class LoginActivityTestEmailSenhaValido {
    ...
    @Test
    public void loginActivityTestEmailSenhaValido() {
        ...
        appCompatEditText.perform(replaceText("zcqayptc@imgof.com"), closeSoftKeyboard());
        ...
        ViewInteraction imageView = onView((withId(R.id.btn_sair)));
        imageView.check(matches(isDisplayed()));

        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.btn_sair), withText("SAIR"), isDisplayed()));
