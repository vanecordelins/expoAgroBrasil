...
public class AlterarProdutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCancelarButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent telaMenu = new Intent(AlterarProdutoActivity.this, MenuActivity.class);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot user : dataSnapshot.getChildren()) {
                    if (user.getKey().equals(uid)) {
                        Produto target = user.getValue(Produto.class);
                        ...
                        ProdutoDAO userDAO = new ProdutoDAO();
                        userDAO.update(target);
                        Toast.makeText(AlterarProdutoActivity.this, "Perfil atualizado com sucesso.", Toast.LENGTH_SHORT).show();
